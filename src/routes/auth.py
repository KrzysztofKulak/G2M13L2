...
from src.schemas import UserIn, UserCreated, Token, RequestEmail
...
# Generate JWT
    ...
    return Token(access_token=access_token, refresh_token=refresh_token) # {"access_token": access_token, "refresh_token": refresh_token, "token_type": "bearer"}
